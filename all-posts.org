...
** TODO Moving My Emacs Configuration to a Literate Programming Document
...
1. Fewest number of Tramp hangs.  This /could/ just be a symptom of my particular setup,
   though.
